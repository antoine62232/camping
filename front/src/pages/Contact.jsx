  ...
  const faqData = [
    {
      ...
      answer:
        "Oui, les animaux sont les bienvenus au Camping Beauvert moyennant un supplément de 5€/jour. Ils doivent être tenus en laisse dans l'enceinte du camping.",
    },
    {
      question: "À quelle heure pouvons-nous arriver ?",
      answer:
        "Les arrivées pour les emplacements se font à partir de 14h00. Pour les locations (Mobil-homes, Chalets), la remise des clés s'effectue à partir de 16h00.",
    },
    {
      question: "La piscine est-elle chauffée ?",
      answer:
        "Tout à fait ! Notre espace aquatique est chauffé à 28°C d'avril à septembre, quelle que soit la météo extérieure.",
    },
    {
      question: "Proposez-vous une assurance annulation ?",
      answer:
        "Oui, lors de votre réservation, vous pouvez souscrire à notre assurance 'Campez Couvert' qui vous protège en cas d'imprévu (maladie, panne, etc.).",
    },
  ];
